...
class messageCog(commands.GroupCog, name="message"):
    ...
    #@app_commands.describe(new_message="The new message to be edited in")
    ...
    #async def delete_message(self, interaction: discord.Interaction, message_url:str, confirm:bool = False):
    #    print(f"Hello from delete-message, {message_url}, {confirm}")
    #    if not interaction.user.guild_permissions.administrator:
    ...
    #        return
    #    elif not confirm:
    #        await interaction.response.send_message(f"The confirm option was not set to true. Are you sure you wanted to delete the message?", ephemeral=True)
    #        return
    #    urlElements = message_url.split("/")
    #    print("Extracted URL elements: ", urlElements)
    #    try:
